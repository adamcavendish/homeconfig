...
"
" 0.9:
" Adding '.rodata' to gasDirective
" Adding '.bss' to gasDirective
" Change '.lcomm' to gasDirectiveStore
" Adding 'popb popw popl popq' to gasOpcode_X64_Base
" Adding '.endm' to gasDirective
...
" directives
syn keyword gasDirective	.abort .ABORT .align .balignw .balignl .bss
...
syn keyword gasDirective	.else .elseif .endef .endif .endm .equ .equiv .eqv .err
...
syn keyword gasDirective	.reloc .rept .rodata .sbttl .scl .section .set .single .size .skip .sleb128
...
syn keyword gasDirectiveStore	.string .string8 .string16 .ascii .asciz .comm .lcomm

syn keyword gasDirectiveMacro	.altmacro .macro .noaltmacro .end .func .endfunc

" i*86 directives
syn keyword gasDirectiveX86	.att_syntax .intel_syntax .att_mnemonic .intel_mnemonic
...
syn keyword gasOpcode_X64_Base		movsx movzx
syn keyword gasOpcode_X64_Base		movsxd movzxd
...
syn keyword gasOpcode_X64_Base		popb popw popl popq
